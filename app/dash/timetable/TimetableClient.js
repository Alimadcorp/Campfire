            ...
            <div className="relative z-10 w-full max-w-6xl">
                ...
                {tasks.length === 0 ? (
                    <div className="bg-white/5 backdrop-blur-md rounded-3xl border-4 border-dashed border-white/20 p-20 text-center">
                        ...
                        <h3 className="text-3xl font-primary mb-2">No tasks scheduled yet</h3>
                        <p className="text-xl text-white/50 mb-8">Start by adding your first mission for the team!</p>
                        <button
                            onClick={() => setIsAddModalOpen(true)}
